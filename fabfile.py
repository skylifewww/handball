...
@task
def prod():
    env.prefix = 'source /home/webmaster/.virtualenvs/handball/bin/activate'
    env.user = 'webmaster'
    env.hosts = ['handball.com']
    env.path = '/home/webmaster/apps/handball'
    env.branch = 'master'
    env.db_name = 'handball'
    env.app = 'handball'
